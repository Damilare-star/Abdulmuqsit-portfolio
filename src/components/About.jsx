          ...
          >
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-center gap-4">
                ...
                <span className="text-gray-700 dark:text-gray-300">Nigeria</span>
              </div>
              <div className="flex items-center gap-4">
                <span className="text-primary font-semibold min-w-[120px]">Email:</span>
                <a href="mailto:abdulmuqsitabdulquadri@gmail.com" className="text-gray-700 dark:text-gray-300 hover:text-primary transition-colors">
                  abdulmuqsitabdulquadri@gmail.com
                </a>
              </div>
              <div className="flex items-center gap-4">
                <span className="text-primary font-semibold min-w-[120px]">Level:</span>
                <span className="text-gray-700 dark:text-gray-300">Skilled Developer</span>
              </div>
            </div>
            <a
              href="/cv.pdf"
